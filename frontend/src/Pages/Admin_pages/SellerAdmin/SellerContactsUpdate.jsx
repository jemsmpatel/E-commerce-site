...
import { useSellerGetContactQuery, useSellerUpdateContactMutation, useSellerDeleteContactMutation } from '../../../redux/api/seller';
import { Link, useLocation, useParams, useNavigate } from 'react-router-dom';
import { toast } from 'react-toastify';
import SellerSideBar from '../../Componants/SellerSideBar';
import Loader from '../../../Structure/Loader';

const SellerContactsUpdate = () => {

    const { id } = useParams();
    const { data, isLoading } = useSellerGetContactQuery(id);
    ...
    const [updateuser, { isUpdatingLoading, updateError }] = useSellerUpdateContactMutation();
    const [deleteuser, { isDeletingLoading, deleteError }] = useSellerDeleteContactMutation();
...
export default SellerContactsUpdate;