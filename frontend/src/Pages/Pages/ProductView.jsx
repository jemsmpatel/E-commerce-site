...
const ProductView = () => {
    ...
    const redirectToOrder = new URLSearchParams(useLocation().search).get('redirect') || '/order';
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div className="flex gap-4">
                                <button onClick={handleOrder} className="bg-orange-600 text-white px-4 py-2 rounded hover:bg-orange-700">
                                    Buy Now
                                </button>
                                <button onClick={handleAddToCart} className="border border-blue-500 text-blue-500 px-4 py-2 rounded hover:bg-blue-700 hover:text-white">
                                    Add to Cart
                                </button>
                            </div>
