...
const SRegistration = () => {
    ...
    const redirect = sp.get('redirect') || '/seller/login';
    ...
    return (
        <div className="flex items-center justify-center py-[50px] bg-gray-100">
            <div className="p-8 rounded-4xl shadow-[0_1rem_3rem_rgba(0,0,0,0.175)] bg-gray-50 w-full max-w-[400px] max-w-sm">
                ...
                <p className="text-gray-600 text-center pb-4 font-semibold">Already have an account? <Link to="/seller/login/" className="text-indigo-600">Sign In</Link>. By clicking Sign up, you agree to the terms of use.</p>
            </div>
        </div>
    );
}
